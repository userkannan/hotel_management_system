...
from .import models
from .forms import SignForm,LoginForm,Online_Booking_form,offline_Booking_form,Add_Employee_form,Add_Room_form,Add_salary_form
...
def authView(request):
    ...
    if request.method == "POST":
        ...
        form = SignForm()
    return render(request,'admin/signup.html',form5)
#login page
...
def All_Room(request):
    ...
    return render(request, 'AllRooms.html',{'data': data})
# def All_Room(request):
#     catagory=models.Add_Room.objects.all()
#     Data={'data':catagory}
#     return render(request,"html/teacher_detail.html",Data)

def AllRooms_Delete(request,id):
    data1 = models.Add_Room.objects.get(Id=id)
    data1.delete()
    return redirect('All_Room')
